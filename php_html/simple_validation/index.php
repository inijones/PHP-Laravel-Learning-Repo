...
<form method="post" action="">
    ...
    <br>
    <input type="text" name="a-word" id="a-word" value="<?= htmlspecialchars($_POST["a-word"] ?? ""); ?>">
    <p class="error" id="a-error"><?= checkWord($_POST["a-word"] ?? "", "a"); ?></p>
    <br>      
      
    Enter a word that starts with the letter "b":
    <br>
    <input type="text" id="b-word" name="b-word" value="<?= htmlspecialchars($_POST["b-word"] ?? ""); ?>">
    <p class="error" id="b-error"><?= checkWord($_POST["b-word"] ?? "", "b"); ?></p>
    <br>      
      
    Enter a word that starts with the letter "c":
    <br>
    <input type="text" id="c-word" name="c-word" value="<?= htmlspecialchars($_POST["c-word"] ?? ""); ?>">
